...
The `paramlink` package has been superseded by the [**ped suite**](https://magnusdv.github.io/pedsuite/). In particular, the main features of `paramlink` can now be found in the following packages:
...
Note that `paramlink` is *not* compatible with the ped suite. It is maintained only for legacy purposes and should not be used in new projects.
